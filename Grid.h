...
public:
	...
	vector < vector<POINT3D>>grid2dprojectioninteriorpoint_outpoint(vector<POINT3D> &incloud, vector < vector<POINT3D>> &smallincloud, double &Gridthreshold, vector<POINT3D> &unprojectionpoints);
	double KNN_dc_noconvergence(vector<POINT3D> &incloud);
